...
console.log(reduce(a, (a, b) => { return a + b }, 0))
...
function textScript(text) {
    ...
    if (total == 0) {
        return "no script found dial tfa7"
    }
...
let nestedArray = [[1, 2], 3, 4, [5, 26, 8,]]

let arrayPeace = nestedArray.reduce( (i, count) => i.concat(count), [])

console.log(arrayPeace)
